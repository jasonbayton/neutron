		<div class="container bytn-footer">
            <div class="row">
				<div class="col-lg-12">
					<div class="pull-right">
						<p>Made with <i class="fa fa-heart text-danger"></i> by <a href="//twitter.com/jasonbayton">@JasonBayton</a>. Material is <i class="fa fa-copyright"></i> <a href="">bayton.org</a> 2008-<?php echo date("Y") ?>.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<script src="<?php echo $theme ["htmlresources"]; ?>/js/scrolling-nav.js"></script>
			<!-- Embed js -->
...
function createToC(){
	...
	$(window.articleWrapperId + " h1, " + window.articleWrapperId + ' h2').each(function(i){
		...
		switch(tag){
			...
			case "H2":
				linnerHTML = "<i class=\"fa fa-ellipsis-h\" aria-hidden=\"true\"></i> " + innerHTML;
				break;
			case "H3":
                                linnerHTML = "<i class=\"fa fa-ellipsis-h\" aria-hidden=\"true\"></i><i class=\"fa fa-ellipsis-h\" aria-hidden=\"true\"></i> " + innerHTML;                                                                                                   break; 
		}
